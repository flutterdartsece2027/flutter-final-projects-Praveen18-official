...
void main() {
  runApp(const AgriReachApp());
}

class AgriReachApp extends StatelessWidget {
  const AgriReachApp({super.key});
    ...
    return MultiProvider(
      ...
      child: MaterialApp(
        ...
        routes: {
          ...
          NearbyServicesScreen.routeName: (ctx) => const NearbyServicesScreen(),
